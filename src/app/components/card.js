...
export function CardH({ img, title, contents, moreInfo, link }) {
    return(
        <div className="nue-card-md grid md:flex p-8 gap-6 place-content-center max-w-screen-md content-stretch snap-center transition-shadow duration-75 motion-reduce:transition-none">
...
export function CardV({ img, title, contents, moreInfo, link }) {
    return(
        <div className="nue-card-md grid p-8 gap-6 place-content-center max-w-screen-lg content-stretch snap-center transition-shadow duration-75 motion-reduce:transition-none">
