import { System, SystemForSmallIcon } from "@/app/components/Memory/System";
import Activity from "@/app/components/Memory/Activity";
import photo from "../../../../public/img/activity_groupPhoto_2022.svg";
import hacker_icon from "../../../../public/img/system_hacker.svg";
import maker_icon from "../../../../public/img/system_maker.svg";
import company_icon from "../../../../public/img/system_company.svg";
...
export function Year_2019() {
    ...
    return (
        <div className="overflow-visible">
            <header>
                <h1 className="bracket-md">2019 梅竹黑客松</h1>
            </header>
            <main>
                <article>
                    <section>
                ...
                <div><Activity posts={activityContent}/></div>
            </main>
        </div>
    );
};
