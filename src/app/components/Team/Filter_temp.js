...
const checkBoxSetStates = [setCreatorGroup, setCompetitionContent, setRegistrationRelated, setOther];


export function CommentItem({ checkBoxSetState, checkBoxState, checkBoxName}) {
  return (
      <div>
